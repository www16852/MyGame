...
window.GAMES_DATA = {
  ...
  news: [
    ...
    },
    {
      date: "2026-09-15",
      gameId: "forsworn",
      title: "《Forsworn》上市 5 天評論成長至 140+ 則、94% 特別好評；首發折扣 -20% 限 9/24 前",
      body: "2026 年 9 月 10 日上市的回合制戰術 Roguelite RPG《Forsworn》Steam 評論已從首日 81 則成長至 140+ 則，好評率穩定在 94%（特別好評）。開發商亦於 9/13 推出 Hotfix 修正吸血鬼 Simmon 的戰鬥行動鎖定 Bug。上市首發 -20% 折扣（NT$ 256，原價 NT$ 320）將於 9 月 24 日截止，有意購入的玩家請把握時機。"
    },
    {
      date: "2026-09-14",
      gameId: "",
  ...
  discover: [
    ...
    },
    {
      ...
      released: "2026年9月10日",
      sort: "2026-09-10",
      rating: "特別好評 94%（140+ 則）",
      reason: "2026 年 9 月 10 日正式上市的回合制戰術 Roguelite RPG。玩家指揮一支被復活的勇士隊伍征戰神祇戰爭撕裂的世界：6 位英雄各有 3 個子職業（Subclass）、150+ 種道具與 200+ 種技能可搭配；每次通關死亡後以更強大的狀態重返，循環進化 Build。最多 4 人線上合作，上線首週評論成長至 140+ 則、94% 特別好評，為 2026 年秋季合作 Roguelite 中最值得關注的新秀；首發 -20% 折扣（NT$ 256）截止 9/24，9/13 已推出 Hotfix 修正戰鬥鎖定 Bug。",
