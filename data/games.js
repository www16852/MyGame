     ...
     games: [                      // 每款遊戲一個物件
       {
         ...
         // Steam 台幣價格與特價（詳見 UPDATE_PROMPT.md 第 3.6 步）
         price: {
           current:  "目前售價，例如 NT$ 699；未定價/未上市留空字串",
           original: "原價（僅特價時填，例如 NT$ 878；否則空字串）",
           discount: "折扣，例如 -20%（沒特價留空字串）",
           note:     "無價格時的說明，例如 尚未定價（Coming Soon）/ 免費（可留空）",
           asOf:     "YYYY-MM-DD 價格查詢日期",
           low:      "Steam 台灣區歷史低價，例如 NT$ 253；查不到留空字串（來源 ITAD，見 3.6 步）",
           lowCut:   "歷史低價當時的折扣，例如 -33%；史低＝原價（未曾特價）則留空",
           lowDate:  "歷史低價出現日期 YYYY-MM-DD"
         },
     ...
     discover: [   // 關注類型中「已上市／搶先體驗、且評價不錯」的新作（詳見 UPDATE_PROMPT.md 第 3.7 步）
       {
         ...
         price: { current, original, discount, note, asOf },  // 同 games[] 的 price（第 3.6 步）
  ...
  games: [
    {
      ...
      price: { current: "", original: "", discount: "", note: "尚未定價（Coming Soon）", asOf: "2026-09-24" },
      events: [
        ...
        { type: "announcement", date: "2026年9月上旬", sort: "2026-09-05", note: "發布全新遊玩預告片（New Gameplay Trailer），進一步展示第二區域「狂風高地（Windhowl Plateau）」的更多場景與玩法：Grand Arena 競技場、火山坑地帶、雪山礦坑，以及神殿建造系統大幅擴充（多主題裝飾與新設施、可規劃房間配置並設置防禦以抵禦入侵者）；再次確認 Steam Next Fest 10月展 Demo（10/20 台灣時間）將首次支援多人連線合作" },
        { type: "announcement", date: "2026年9月22日", sort: "2026-09-22", note: "加入「2026 多人遊戲節（2026 Multiplayer Games Fest）」Steam 展示：開發商 Geo Seed Games 正式揭露多人連線規劃——上市後支援 P2P 連線（適合小型私人冒險，可自訂規則）與正式伺服器（Dedicated Servers，可容納更多玩家、支援公會 Clan 與領地 Territory 系統）兩種模式；即將開放的 10 月 Demo（10/20 起）將首次支援 P2P 多人遊玩，玩家可邀請好友一同探索 Edda、合作或對抗；正式上市日期仍為 TBA" },
        { type: "demo", date: "2026年10月20日（Steam Next Fest 10月展）", sort: "2026-10-20", note: "2026年8月28日官方公告：遊戲將參加 Steam Next Fest 10月展，Demo 定於 10月20日向所有玩家免費開放；首次加入多人連線合作（Online Multiplayer Co-op）功能；可遊玩首個區域「翠綠谷（Verdant Valley）」，開發商已針對大眾測試做進一步優化。Steam Next Fest October 2026 正式日期為 10/19~10/26 PDT（台灣時間 10/20 凌晨起）" },
    ...
    },
    {
      ...
      price: { current: "", original: "", discount: "", note: "尚未定價；試玩版免費開放中（Coming Soon）", asOf: "2026-09-24" },
      events: [
        ...
        { type: "announcement", date: "2026年8月25日", sort: "2026-08-25", note: "Demo Patch 0.5.6 推送（第六次週更平衡 Patch，本次規模略小，部分團隊成員已開始休假）：新增「戰鬥結果面板（Battle Results Panel）」功能，非立即獲得的遺物/道具將顯示名稱與觸發事件來源；商店重擲（Reroll）時不再重複完全相同的陣容；含多項 Bug 修復；Steam 試玩版持續維持特別好評水準" },
        { type: "announcement", date: "2026年9月1日", sort: "2026-09-01", note: "Demo Patch 0.5.7 推送：新增戰鬥結束後於 Red Rift 畫面顯示歷史最高連勝數（Highest Win Streak）與累計總勝場數；修正 Shard Maximizer 計算邏輯、傷害免疫角色互動異常與多項效能問題；開發團隊同步表示正「緩步進入一個新階段」，Demo 內容將維持現狀，開發重心轉移至完整版本（1.0）；Demo 後續將以 Bug 修復與平衡維護為主，並規劃正式版上市前的封閉 Beta 測試機會" },
  ...
  news: [
    {
      date: "2026-09-24",
      gameId: "forsworn",
      title: "《Forsworn》開發者公布後續路線圖：11~12 月首位免費新英雄與4人合作強化，2027年推出資料片",
      body: "Resummon Studios 開發者 Dat 公布《Forsworn》後續開發計畫：2026 年 11~12 月將推出首位免費新英雄並進一步強化四人合作（4-player co-op）體驗；2027 年 1 月再加入第二位免費新英雄；2027 年 4~5 月推出付費資料片，帶來全新地圖、戰鬥遭遇、神秘事件、多樣化敵人與 Boss、新道具、祝福系統、更高難度等豐富新內容，另含額外可玩英雄。開發者表示：「這是一段令人難以置信的旅程，我從未料到自己的第一款遊戲能被如此多人遊玩並喜愛。」Steam 評論已成長至 299 則（89% 特別好評）；首發 -20% 折扣（NT$ 256，原價 NT$ 320）今日（9/24）截止，有意購入請把握最後機會。"
    },
    {
      date: "2026-09-23",
      gameId: "guildrun",
      title: "《Guildrun》Demo Patch 0.5.10 推送：首次內部雙人合作試玩，修正多件裝備屬性更新異常",
      body: "Leyline 於 9 月 23 日推出試玩版第十次 Demo Patch（0.5.10），以 Bug 修復為主：修正 Warrior's Greataxe、Tank's Tower Shield、Vanguard's Bracelet、Assassin's Hood、Duelist's Foil、Mage's Wand、Mystic's Orb 等多件裝備僅於戰鬥開始時更新屬性加成的問題；修正 Trial 事件結果畫面不顯示獎勵的問題；修正 1v1 Trial 遺物與道具選擇標題不一致問題。本次最大亮點為開發團隊同步揭露：本週已進行首次雙人合作（2-player co-op）模式內部試玩（studio-internal playtest），命中回饋、衝刺/停頓視覺效果持續優化；Demo 持續維護模式，完整版開發穩步推進，預計 2027 年上市前規劃封閉 Beta。"
    },
    {
      date: "2026-09-22",
      gameId: "neverwither",
      title: "《不朽之樹》加入 2026 多人遊戲節，正式揭露 P2P 與官方伺服器雙模式多人規劃",
      body: "Geo Seed Games 宣布《不朽之樹》加入「2026 Multiplayer Games Fest」Steam 展示，並借此正式揭露完整多人規劃：上市後支援 P2P 連線（小型私人冒險，玩家可自訂規則）與官方伺服器（Dedicated Servers，支援更多玩家同時上線，提供公會 Clan 組建與領地 Territory 系統）兩種模式。即將開放的 10 月 Steam Next Fest Demo（10/20 起）將首次支援 P2P 多人遊玩，玩家可邀請好友一同探索 Edda 大陸、合作或對抗。距 Demo 約剩一個月，正式上市日期仍為 TBA。"
    },
    {
      date: "2026-09-21",
      gameId: "forsworn",
      title: "《Forsworn》v1.0.18 QoL Patch 上線：英雄與 UI 動畫加速選項，首發折扣 9/24 截止",
      body: "Resummon Studios 於 9 月 21 日推出 v1.0.18 QoL Patch：新增「更快玩家速度（Faster Player Speed）」選項，可在遊戲設定中開啟/關閉英雄動畫與 UI 動畫加速，讓習慣快節奏操作的玩家更流暢；另含多項 Bug 修正。目前 Steam 評論持續成長（89% 特別好評），首發 -20% 折扣（NT$ 256，原價 NT$ 320）將於 2026 年 9 月 24 日截止，有意購入的玩家請把握最後機會。"
    },
    {
      date: "2026-09-21",
      gameId: "stonewards",
      title: "《Stonewards》Hotfix 0.2.2 推出：黃金戒指倍率上限設定、多人重加入存檔完整修正",
      body: "Banana Tiger Studio 於 9 月 21 日推出 Hotfix 0.2.2，修正重大 9 月更新後回報的問題：平衡調整方面，黃金戒指（Gold Ring）的最大倍率上限設為 200x，防止無限堆疊；Bug 修復方面，修正多人模式中已有玩家正在被 Revive Bed 復活時仍出現 Game Over 畫面的問題，以及玩家重新加入多人局時戒指重擲次數（Ring Rerolls）、跳過次數（Skips）、隊伍魔法書加成（Team Tome Bonuses）和擊殺累積最大生命等數值不正確還原的問題。Steam 評論持續 94%（特別好評）。"
    },
    {
      date: "2026-09-18",
      gameId: "forsworn",
      title: "《Forsworn》v1.0.17 推送：新增「2 Hero Party」功能，玩家可選擇以 2 人小隊起跑",
      body: "Resummon Studios 於 9 月 18 日推出 v1.0.17，新增「2 Hero Party」選項——玩家現可在起跑時選擇以 2 人或 3 人英雄小隊展開冒險（先前固定 3 人），讓策略配置更為靈活，同時含多項修正與穩定性改善。Steam 評論已成長至 279 則、好評率 89%（特別好評）；首發 -20% 折扣（NT$ 256）截止 9/24，有意購入的玩家請把握最後倒數。"
    },
    {
      date: "2026-09-21",
      gameId: "grainrot",
      title: "《Grain Rot》展開限時 -15% 特賣（NT$ 129），截止 2026 年 9 月 26 日",
      body: "《GRAIN ROT》在 Steam 台灣區展開限時 -15% 特賣，現價 NT$ 129（原價 NT$ 152），截止日期為 2026 年 9 月 26 日。這是 2026 年 8 月 7 日上市以來的第一次折扣活動；截至目前評論數已成長至 1,879 則，好評率維持 88%（特別好評）、近 30 天 87%；有意購入的玩家請把握機會，首個重大更新「Deep Layers Update」與萬聖節更新均計劃近期推出。"
    },
    {
      date: "2026-09-18",
      gameId: "valheim",
      title: "《Valheim》1.0 連推 Patch 1.0.14（9/17）與 1.0.15（9/18）：地形重疊效能修正",
      body: "Iron Gate 於 1.0 正式版上市後繼續快速修補：Patch 1.0.14（9/17）新增按鍵設定音樂相關調整與多項 Hotfix；Patch 1.0.15（9/18）修復一個導致部分玩家出現「地形重疊（duplicated terrains）」並造成效能下降的問題，受影響玩家需手動進行地形操作（Terrain Deformation）以消除殘留接縫。目前 Steam 整體評價持續維持壓倒性好評 94%（261,000+ 則）。"
    },
    {
      date: "2026-09-16",
      gameId: "guildrun",
      title: "《Guildrun》Demo Patch 0.5.9 推送：第九次週更，縮減規模、加強可行策略選擇",
      body: "Leyline 推出試玩版第九次平衡更新 Patch 0.5.9，以數值微調（numbers-only）為主：對道具、遺物、職業修改器（Class Modifiers）與表現不佳的英雄專精進行強化，目標在各遊戲模式中擴大玩家的可行策略；開發團隊同步表示已開始「縮減每次 Patch 規模」，以將開發重心集中於完整版（1.0）上市準備。Demo 持續進入維護模式，正式版目標 2027 年，上市前規劃封閉 Beta 測試。"
    },
    {
      date: "2026-09-15",
      gameId: "forsworn",
      title: "《Forsworn》v1.0.16 地圖繪製 Patch 上線：玩家可在世界地圖自由繪圖、多項 Bug 修正",
      body: "Resummon Studios 於 9 月 15 日推出 v1.0.16「Map Drawing Patch」：新增玩家可在世界地圖上自由手繪的功能；「無盡模式」於關卡中目標欄新增剩餘波次顯示；Bug 修正包含「黑暗死靈法師（Dark Necromancer）」以援軍身分登場時不再在出現當回合就攻擊或召喚部下、其死亡時不再觸發額外敵方回合、英雄讀取存檔後不再以死亡狀態出現，以及 Panther 的 Death Grasp 技能現可於 Act 3 地穴墓碑（Crypt Tomb）處被淨化等；上市首發 -20% 折扣（NT$ 256）截止 9/24。Steam 整體評論持續成長，好評率仍在特別好評水準。"
    },
    {
      date: "2026-09-17",
      gameId: "stonewards",
      title: "《Stonewards》重大 9 月更新正式上線：傭兵系統、每週排行榜與大量新裝備",
      body: "Banana Tiger Studio 宣告中的重大 9 月更新正式上線：玩家現可在 Hub 中雇用傭兵（Mercenaries）協助探索，特別適合單人玩家；新增每週排行榜（Weekly Leaderboard）供玩家以跑分競技；大量新裝備加入——武器含釘錘（Mace）、傳奇弓（Legendary Bow）、傳奇小斧（Legendary Small Axe）與雙小斧（Double Small Axe）；新戒指含爆炸戰鬥範圍、魔法範圍、格擋治療與挖掘速度；升級書新增羅盤範圍、隊伍攻擊、隊伍最大生命、珍貴寶物與鍛造加成；同步進行多項平衡調整（永久黃金升級與黃金戒指改為乘法累計）。Steam 評論達 800 則，好評率持續維持 94%（特別好評）。"
    },
    {
      date: "2026-09-17",
      gameId: "subnautica2",
      title: "《深海迷航 2》Buddy System Hotfix 1（9/1）與後續修補（9/3）：Axum 渦輪修復、近距語音改 PTT",
      body: "Unknown Worlds 於 9 月 1 日推出 Buddy System Hotfix 1，修正 Axum Powerplant Turbine 無法恢復問題、Proximity Chat（近距語音）改為按鍵通話（Push-to-Talk）模式、基地牆架退款返還，以及多項合作遊玩、生物、UI 與穩定性修正；9 月 3 日發布後續修補，進一步修正受影響 Turbine 資料。目前公開版本為 Hotfix 1 穩定版；Steam 近 30 天好評率持續維持 90%（特別好評）。"
    },
    {
      date: "2026-09-16",
      gameId: "forsworn",
      title: "《Forsworn》公布 Act 2 開發計畫：2027 年 1 月中旬開放 Playtest，含 Draft 新模式",
      body: "Resummon Studios 公布《Forsworn》後續開發路線：Act 2 預計 2027 年 1 月中旬開放 Playtest，帶來 20 場全新遭遇、50+ 種新敵人，以及靈感源自卡牌遊戲的全新「Draft 模式」（玩家可組建強力新隊伍直接從 Act 2 出發，無需重跑 Act 1）。首發 -20% 折扣（NT$ 256，原價 NT$ 320）截止 9 月 24 日，有意購入的玩家請把握最後倒數。"
    },
    {
      date: "2026-09-16",
      gameId: "",
      title: "《Chained Beasts》確認 10/15 多平台同步上市，首日登陸 Xbox Game Pass",
      body: "Featherweight Games 的 1~4 人合作角鬥士 Roguelike《Chained Beasts》確認 2026 年 10 月 15 日在 Steam、Xbox Series X|S、PS5 與 Nintendo Switch 同步上市，並於發售首日登陸 Xbox Game Pass（PC/主機）。Steam 試玩版累積 683 則評論、97% 壓倒性好評，知名實況主 IronPineapple 與 VaatiVidya 盛讚為「史上最佳試玩版之一」。正式版口碑若達標，將優先評估加入新品推薦。"
    },
    {
      date: "2026-09-16",
      gameId: "",
    ...
    },
    {
      date: "2026-09-15",
      gameId: "valheim",
      title: "《Valheim》1.0 上市後推出 Hotfix 1.0.10 & 1.0.12：Deep North 鎧甲維修、崩潰修正",
      body: "Iron Gate 於 9 月 11 日（1.0 上市後約 48 小時）推出兩波熱修復：Hotfix 1.0.10（全平台）修正 Deep North 重甲無法維修、Boss 生成、物品架、伺服器黑白名單與成就相關 Bug；Hotfix 1.0.12（Steam 優先，後續推送至全平台）進一步修正更多崩潰問題並優化跨平台連線相容性。Switch 2 版本因平台認證流程，1.0.12 修復將於後續更新補上。Steam 整體評價維持壓倒性好評 94%（261,000+ 則），近 30 天 85%（6,996 則）。"
    },
    {
      date: "2026-09-15",
      gameId: "sephiria",
      title: "《Sephiria》Steam 台灣區售價由 NT$ 268 調漲至 NT$ 343",
      body: "1.0 正式版（2026 年 7 月 31 日）上市後，《Sephiria》在 Steam 台灣區售價已從 NT$ 268 上調至 NT$ 343（調幅約 28%）。英語評論已成長至壓倒性好評 96%（2,731 則，近 30 天 95%），整體口碑依然亮眼；欲購入的玩家應留意售價調整。"
    },
    {
      date: "2026-09-15",
      gameId: "stonewards",
      title: "《Stonewards》「重大 9 月更新」截至 9/15 仍未上線；評論成長至 800 則，好評率 94%",
      body: "Banana Tiger Studio 宣告中的「重大 9 月更新」截至 9 月 15 日仍未推出；開發商確認除主要新功能外，亦持續評估玩法、平衡與整體打磨等社群要求，更新「即將推出」。Steam 評論已從上市初 527 則大幅成長至 800 則，好評率由壓倒性好評 95% 略降至特別好評 94%，整體口碑依然穩健。"
    },
    {
      date: "2026-09-15",
      gameId: "forsworn",
      title: "《Forsworn》上市 5 天連出 4 波 Patch（v1.0.12~v1.0.15），評論成長至 141 則、93% 特別好評",
      body: "2026 年 9 月 10 日上市的回合制戰術 Roguelite RPG《Forsworn》開發商持續快速響應玩家回饋：v1.0.13（9/11）新增 Gamepad 右搖桿鏡頭旋轉、Upgrade Sites 顯示升級代幣說明、提升敵人移動路徑亮度、修正 Jailor 監獄永久困住英雄 Bug；v1.0.14（9/12）加入可切換的永久敵人血條顯示、更清楚的多人 Ping 說明與語言選擇按鈕；Simmon 吸血鬼 Hotfix（9/13）修正從第 2 回合起行動完全鎖定的嚴重 Bug；v1.0.15（9/14）新增多人回合指示器、永久英雄血條、更快的開箱動畫，並修正多項技能與物品異常。Steam 評論已成長至 141 則，好評率 93%（特別好評）。首發 -20% 折扣（NT$ 256，原價 NT$ 320）截止 9/24，有意購入的玩家請把握時機。"
    },
    {
      date: "2026-09-14",
      gameId: "",
    ...
    },
    {
      ...
      title: "《Shift at Midnight》上市首發 -10% 折扣結束，回復原價 NT$ 216",
      body: "《Shift at Midnight》在 Steam 的 -10% 首發折扣（NT$ 194）已結束，遊戲回復原價 NT$ 216。此次首發折扣為 Steam 台灣區歷史低點（lowCut -10%，2026-07-22）；Q4 2026 預計推出免費大型「ENDLESS MODE」更新，帶來獨佔顧客、武器、陷阱與怪物。整體評價持續維持特別好評 94%（4,359 則）。"
    },
    {
      date: "2026-09-11",
      gameId: "farfarwest",
      title: "《Far Far West》Frostburn 上市促銷（-20%）結束，價格回復 NT$ 358",
      body: "Evil Raptor《Far Far West》配合首個重大更新「Frostburn」（8/27 上線）的兩週特賣（-20%，NT$ 286）已告結束，遊戲回復 EA 原價 NT$ 358。此折扣為 Steam 台灣區歷史低點（lowCut -20%，2026-08-27）；下次特賣時間未定，有意購入的玩家可先加入願望清單等候。遊戲整體評價持續維持壓倒性好評 96%（36,000+ 則）。"
    },
    {
      date: "2026-09-11",
      gameId: "stonewards",
      title: "《Stonewards》宣告中的「重大 9 月更新」截至今日仍未上線，開發持續進行中",
      body: "Banana Tiger Studio 稍早宣告的《Stonewards》重大 9 月更新截至 9 月 11 日仍未推出；開發商確認除主要公告功能外，亦持續評估社群要求的更多改善，包含玩法、平衡與整體打磨，更新即將推出。Steam 評價持續維持壓倒性好評 95%。"
    },
    {
      date: "2026-09-11",
      gameId: "grainrot",
      title: "《Grain Rot》「Deep Layers Update」截至 9/11 仍未上線，萬聖節更新計畫 10 月推出",
      body: "Beck & Branch Games《Grain Rot》首個重大內容更新「Deep Layers Update」截至 9 月 11 日仍未上線（Patch 1.09 為最新版本）。開發商（兩人小組）持續確認更新「即將推出」，預計帶來全新深層生態系與數種新敵人。萬聖節更新（Halloween Update）計劃 10 月推出，將開放 Outpost 第三層與新任務線。Steam 整體評論 1,764 則，好評率 88%（特別好評）。"
    },
    {
      date: "2026-09-10",
      gameId: "neverwither",
      title: "《不朽之樹》發布全新遊玩預告片，揭露狂風高地更多場景與神殿建造擴充",
      body: "Geo Seed Games 於 9 月上旬發布最新遊玩預告片（New Gameplay Trailer），進一步展示第二區域「狂風高地（Windhowl Plateau）」：Grand Arena 競技場、火山坑地帶、雪山礦坑等多元場景，以及神殿建造系統大幅擴充（多主題裝飾與新設施、可規劃房間配置並設置防禦以抵禦入侵者）。Steam Next Fest October 2026 正式日期確認為 10/19~10/26 PDT（台灣時間 10/20 凌晨起），Demo 將首次支援多人連線合作並可遊玩翠綠谷區域，正式上市日期仍為 TBA。"
    },
    {
      date: "2026-09-10",
      gameId: "stonewards",
      title: "《Stonewards》Hotfix 0.1.8（8/26）：多人波次暫停機制上線，「重大 9 月更新」尚未發布",
      body: "Banana Tiger Studio 於 8 月 26 日推出 Hotfix 0.1.8：新增多人波次暫停機制（全員選完升級後須等待任一玩家按繼續才開始下波）、敵人卡關時自動脫離追擊、進度自動備份最多 20 份本地存檔（防止雲端同步異常）、修復 Bed 復活相關 Bug。截至 9/10，開發團隊宣布中的「重大 9 月更新」仍未上線；Steam 評價持續維持壓倒性好評 95%。"
    },
    {
      date: "2026-09-09",
      gameId: "guildrun",
      title: "《Guildrun》Patch 0.5.7 & 0.5.8 推送，開發重心正式轉向完整版（1.0）開發",
      body: "Leyline 相繼推出試玩版 Patch 0.5.7（9/1）與 0.5.8：0.5.7 新增戰鬥結束後於 Red Rift 畫面顯示歷史最高連勝數與總勝場數，修正 Shard Maximizer 計算邏輯及多項效能問題；0.5.8 修復 Acceleration Prism 機制、對已死亡單位施加狀態效果的 Bug、視覺特效異常與任務進度上限問題。開發團隊同步宣告正「緩步進入一個新階段，Demo 內容將維持現狀，開發重心轉移至完整版本（1.0）」；Demo 後續僅提供維護性更新，正式版上市前規劃封閉 Beta 測試。"
    },
    {
      date: "2026-09-09",
      gameId: "windrose",
      title: "《Windrose》Steam 首發 -10% 折扣結束，回復原價 NT$ 488",
      body: "《Windrose》在 Steam 的 -10% 首發折扣（NT$ 439）已告結束，遊戲回復原價 NT$ 488。首個重大更新「Ashlands」計劃最早 10 月底前後推出，帶來新生態區與玩法進化，屆時或有機會搭配折扣活動。"
    },
    {
      date: "2026-09-08",
      gameId: "scrapmechanic",
    ...
    },
    {
      date: "2026-09-07",
      gameId: "",
      title: "「新品推薦」輪替：補入《Rotwood》（多人RogueLike）與《Shift at Midnight》（多人生存）",
      body: "本次輪替移出《Tears of Metal》（割草 Roguelike EA，好評率趨穩於 85%，由更高評分新作取代）與《Funnel Runners》（多人生存逃脫，好評率降至 83% 接近門檻）；補入《Rotwood》（Klei Entertainment，4 人合作近戰 Roguelike，2026 年 3 月 3 日正式版，特別好評 90%、2,213 則，台灣 NT$ 421）及《Shift at Midnight》（深夜加油站合作恐怖推理生存，1~3 人線上合作，2026 年 7 月 22 日上線，特別好評 94%、4,359 則，現售 NT$ 194）。"
    },
    {
      date: "2026-09-05",
      gameId: "grainrot",
      title: "《Grain Rot》首個重大更新「Deep Layers Update」預計 9 月推出，新增生態系與新敵人",
      body: "《GRAIN ROT》開發商 Beck & Branch Games 預告首個重大內容更新「Deep Layers Update」預計 9 月發布，將新增一個全新生態系及數種新敵人，為 EA 上市（8/7）以來規模最大的一次更新。上一更新 Patch 1.09 修正了羅盤物品校準、Vibe Modulator 廢料值與視覺效果效能問題。Steam 評論數持續穩定成長至 1,719 則，整體好評率維持 88%（特別好評）。"
    },
    {
      date: "2026-09-02",
      gameId: "guildrun",
      title: "《Guildrun》週更 Patch 0.5.6（8/25）後暫停，開發團隊部分成員休假中",
      body: "Leyline《Guildrun》試玩版的週更節奏自 8 月 25 日 Patch 0.5.6 後暫時中斷（開發商於 0.5.6 公告中已提及「部分團隊成員已開始休假」）；截至 9/2 未見 Patch 0.5.7 釋出。Steam 試玩版持續維持特別好評水準，試玩版仍免費對外開放，正式版目標上市年份為 2027 年。"
    },
    {
      date: "2026-09-01",
      gameId: "neverwither",
    ...
    },
    {
      date: "2026-08-28",
      gameId: "farfarwest",
      title: "《Far Far West》配合「Frostburn」上線展開 -20% 兩週特賣，NT$ 286 創 Steam 台灣區史低",
      body: "Evil Raptor 配合 8 月 27 日「Frostburn」更新正式上線，對《Far Far West》展開為期約兩週的限時特賣（-20%，現價 NT$ 286，原價 NT$ 358），為 Steam 台灣區歷史低價新紀錄（前低 NT$ 322，-10%，2026-04-28）。Frostburn 為 EA 上市以來最大規模更新，包含全新敵人派系「Zurkers」、兩張全新地圖（Redwood Forest 巨木森林與 Hellfire 荒地）、近戰武器系統全面上線、盾牌防禦機制、30+ 種全新 Joker 修改器及燈塔探索點；目前整體評價壓倒性好評 96%（35,000+ 則）。"
    },
    {
      date: "2026-08-27",
      gameId: "farfarwest",
      title: "《Far Far West》EA 首個重大更新「Frostburn」今日正式上線",
      body: "Evil Raptor《Far Far West》首個重大更新「Frostburn」已於 2026 年 8 月 27 日正式向全體玩家推送。完整確認內容包含：全新科幻侵略派系「Zurkers」（新敵人陣營）、Redwood Forest 巨木森林新地圖（高聳巨木可攀爬、立體平台戰鬥）、Hellfire 荒地新地圖、近戰武器系統全面上線、盾牌防禦機制、全新探索點「燈塔（Lighthouse）」（攀爬後完成小遊戲解鎖全圖視野）、30+ 種全新 Joker 修改器及全新角色外觀，並對舊地圖進行內容擴充。此為 EA 上市（4/28）以來規模最大的更新；Gamescom 現場玩家已於昨日（8/26）13:00 CET 搶先 24 小時體驗。"
    },
    {
      date: "2026-08-26",
      gameId: "farfarwest",
      title: "《Far Far West》「Frostburn」今日 Gamescom 搶先體驗開放，完整內容確認，明日（8/27）全面上線",
      body: "Evil Raptor《Far Far West》首個重大更新「Frostburn」於今日（8/26）13:00 CET 在德國科隆 Gamescom（Hall 10.2，Booth 131）開放搶先 24 小時試玩，明日（8/27）正式向全體玩家推送。最終確認內容包含：全新科幻侵略派系「Zurkers」（新敵人陣營）、Redwood Forest 巨木森林全新地圖（高聳巨木可攀登垂直平台進行立體戰鬥）、近戰武器系統（多種近戰武器全面上線）、全新探索點「燈塔（Lighthouse）」（需攀登並完成小遊戲以解鎖全圖視野）、30+ 種全新 Joker 修改器及全新角色外觀，並對舊地圖進行內容擴充。"
    },
    {
      date: "2026-08-25",
      gameId: "guildrun",
      title: "《Guildrun》Demo Patch 0.5.6 推送：第六次週更，新增戰鬥結果面板顯示遺物來源",
      body: "Leyline 於 8 月 25 日推出試玩版第六次平衡更新 Patch 0.5.6（本次規模略小，部分團隊成員已開始休假）：新增「戰鬥結果面板（Battle Results Panel）」功能，非立即獲得的遺物/道具將顯示名稱與觸發事件來源；商店重擲（Reroll）時不再重複完全相同的陣容；含多項 Bug 修復。自 7/16 Demo 上線以來，開發商已連續六週不間斷推送週更 Patch，Steam 試玩版持續維持特別好評水準。"
    },
    {
      date: "2026-08-25",
      gameId: "farfarwest",
      title: "《Far Far West》Frostburn 更新倒數 2 天，開發日誌透露 Zurkers 派系、近戰武器與新地圖",
      body: "距《Far Far West》EA 首個重大更新「Frostburn」（8/27 上線）僅剩 2 天。開發商雖表示完整更新細節將於當日公開，但開發日誌已透露本次更新預計帶來：全新科幻派系「Zurkers」、Hellfire 荒地與 Redwood Forest 兩張全新地圖、近戰武器系統、盾牌防禦機制、30+ 種全新 Joker 修改器及燈塔探索點；Gamescom 現場（Booth 131, Hall 10.2）玩家可於 8/26 13:00 CET 搶先 24 小時體驗。"
    },
    {
      date: "2026-08-24",
      gameId: "farfarwest",
  ...
  discover: [
    {
      ...
      price: { current: "NT$ 499", original: "", discount: "", note: "", asOf: "2026-09-24", low: "NT$ 499", lowCut: "", lowDate: "2026-03-05" },
    ...
    },
    {
      ...
      price: { current: "NT$ 343", original: "", discount: "", note: "", asOf: "2026-09-24", low: "NT$ 160", lowCut: "-40%", lowDate: "2026-07-31" },
      released: "2026年7月31日（1.0 正式版）",
      sort: "2026-07-31",
      rating: "壓倒性好評 96%（英語 2,731 則）；近 30 天 95%",
      reason: "《Dungreed》主創 TEAM HORAY 的最新力作。俯視角動作 Roguelite，6 種武器各有 50+ 升級路線，搭配神器與石板打造千變萬化的 Build；最多 4 人線上合作，隊友間可交易道具並互相復活。2026 年 7 月 31 日 1.0 正式上線後峰值逾 24,000 人同時在線；英語評論壓倒性好評 96%（2,731 則，近 30 天 95%），是 2026 年合作 Roguelite 中口碑最突出的作品之一。注意：1.0 上線後售價已從 NT$ 268 調漲至 NT$ 343（約 28% 漲幅），欲購入的玩家請留意。持續推出月度更新完善遊戲體驗。",
    ...
    },
    {
      ...
      price: { current: "NT$ 699", original: "", discount: "", note: "", asOf: "2026-09-24", low: "NT$ 699", lowCut: "", lowDate: "2026-05-11" },
    ...
    },
    {
      ...
      platforms: ["PC"],
      playerCount: "單人 / 多人合作",
      price: { current: "NT$ 561", original: "", discount: "", note: "", asOf: "2026-09-24", low: "NT$ 253", lowCut: "-33%", lowDate: "2026-06-25" },
    ...
    },
    {
      ...
      price: { current: "NT$ 488", original: "", discount: "", note: "", asOf: "2026-09-24", low: "NT$ 439", lowCut: "-10%", lowDate: "2026-04-14" },
    ...
    },
    {
      ...
      platforms: ["PC"],
      playerCount: "1~4 人合作",
      price: { current: "NT$ 358", original: "", discount: "", note: "", asOf: "2026-09-24", low: "NT$ 286", lowCut: "-20%", lowDate: "2026-08-27" },
      released: "2026年4月28日 搶先體驗",
      sort: "2026-04-28",
      rating: "壓倒性好評 96%（36,035 則）；近 30 天特別好評 89%",
      reason: "西部奇幻風合作 Roguelite FPS：1~4 人隊伍在程序生成荒野中接取賞金獵人任務，融合《深岩銀河》式的任務框架與 Roguelite 輪迴進度。2026 年 4 月 28 日搶先體驗上線即獲壓倒性好評 96%（35,000+ 則），銷量突破 50 萬份，多家媒體譽為「2026 年最令人驚喜的合作 Roguelite」。EA 首個重大更新「Frostburn（冰霜燃燒）」已於 8 月 27 日正式上線（為 EA 上市以來最大規模更新）：全新科幻侵略派系「Zurkers」（新敵人陣營）、Redwood Forest 巨木森林新地圖（高聳巨木可攀爬、立體平台戰鬥）、Hellfire 荒地新地圖、近戰武器系統全面上線、盾牌防禦機制、全新探索點「燈塔（Lighthouse）」（攀爬後完成小遊戲解鎖全圖視野）、30+ 種全新 Joker 修改器及全新角色外觀，並對舊地圖進行內容擴充。",
    ...
    },
    {
      ...
      platforms: ["PC"],
      playerCount: "單人 / 1~4 人線上合作",
      price: { current: "NT$ 216", original: "", discount: "", note: "", asOf: "2026-09-24", low: "NT$ 194", lowCut: "-10%", lowDate: "2026-08-11" },
      released: "2026年8月11日 搶先體驗",
      sort: "2026-08-11",
      rating: "特別好評 94%（800 則）",
      reason: "1~4 人合作的第一人稱 Roguelite 防守新作：程序生成礦坑採礦→鍛造升級→抵禦怪物波次的緊湊輪迴循環，每次遊玩路線皆不相同。2026 年 8 月 11 日 EA 上線（$9.99），首發即獲壓倒性好評 95%（527+ 則）；「重大 9 月更新」已正式上線：傭兵系統（Hub 可雇用 Mercenaries）、每週排行榜、多種新武器與戒指、升級書擴充；Hotfix 0.2.1（9/15）與 Hotfix 0.2.2（9/21）後續修正：黃金戒指倍率上限設為 200x、多人重加入局時戒指重擲次數/隊伍加成等數值正確還原；Steam 評論達 800 則，好評率 94%（特別好評），是 2026 年秋季合作 Roguelite 中持續更新、口碑穩健的推薦之作。",
    ...
    },
    {
      ...
      platforms: ["PC"],
      playerCount: "單人 / 1~4 人線上合作",
      price: { current: "NT$ 256", original: "NT$ 320", discount: "-20%", note: "上市首發折扣（截止 2026/9/24）", asOf: "2026-09-24", low: "NT$ 256", lowCut: "-20%", lowDate: "2026-09-10" },
      released: "2026年9月10日",
      sort: "2026-09-10",
      rating: "特別好評 89%（299 則）",
      reason: "2026 年 9 月 10 日正式上市的回合制戰術 Roguelite RPG。玩家指揮一支被復活的勇士隊伍征戰神祇戰爭撕裂的世界：6 位英雄各有 3 個子職業（Subclass）、150+ 種道具與 200+ 種技能可搭配；每次通關死亡後以更強大的狀態重返，循環進化 Build。最多 4 人線上合作，評論已成長至 299 則（89% 特別好評），為 2026 年秋季合作 Roguelite 中最值得關注的新秀。開發商積極響應回饋：v1.0.12~v1.0.15（9/11~9/14）含 Gamepad 支援、永久血條、多人回合指示器與 Simmon 嚴重 Bug 修正；v1.0.16（9/15「Map Drawing Patch」）新增世界地圖手繪、無盡模式剩餘波次顯示；v1.0.17（9/18）新增「2 Hero Party」功能（可選 2 人或 3 人小隊起跑）；v1.0.18（9/21 QoL Patch）新增「更快玩家速度」選項，可在設定中開啟英雄與 UI 動畫加速。開發路線圖（9/24 公布）：2026 年 11~12 月推出首位免費新英雄並強化四人合作；2027 年 1 月加入第二位免費新英雄；2027 年 4~5 月推出付費資料片（全新地圖、敵人、Boss、道具、更高難度等）。首發 -20% 折扣（NT$ 256）今日（9/24）截止。",
      links: { steam: "https://store.steampowered.com/app/3560360/Forsworn/", official: "" }
    },
    {
      id: "shiftatmidnight",
      name: "Shift at Midnight",
      nameEn: "Shift at Midnight",
      interest: "多人生存",
      genre: "合作恐怖推理生存",
      developer: "",
      platforms: ["PC"],
      playerCount: "單人 / 1~3 人線上合作",
      price: { current: "NT$ 216", original: "", discount: "", note: "", asOf: "2026-09-24", low: "NT$ 194", lowCut: "-10%", lowDate: "2026-07-22" },
      released: "2026年7月22日",
      sort: "2026-07-22",
    ...
    },
    {
      ...
      price: { current: "NT$ 648", original: "", discount: "", note: "", asOf: "2026-09-24", low: "NT$ 159", lowCut: "-50%", lowDate: "2024-12-13" },
      released: "2026年9月9日（1.0 正式版）",
      sort: "2026-09-09",
      rating: "壓倒性好評 94%（261,000+ 則）；Metacritic 90；近 30 天 85%",
      reason: "歷經五年以上搶先體驗後，傳奇維京生存建造《Valheim》終於於 2026 年 9 月 9 日推出 1.0 正式版。最終章全新生態區「Deep North（冰封北境）」帶來 40+ 種武器、10+ 種新生物、80+ 種可建造組件，以及完整的故事終章。1.0 首日峰值達 160,000 人同時在線；支援全平台跨平台連線（PC/Xbox/PS5/Switch 2），最多 10 人合作。Metacritic 90，壓倒性好評 94%（261,000+ 則），是 2026 年最受矚目的生存遊戲里程碑事件。上市後 Iron Gate 持續快速修補：Hotfix 1.0.10 & 1.0.12（9/11）修正重甲維修、Boss 生成、伺服器黑白名單及崩潰；Patch 1.0.14（9/17）新增按鍵音樂設定調整；Patch 1.0.15（9/18）修復地形重疊（duplicated terrains）導致部分玩家效能下降的問題。",
